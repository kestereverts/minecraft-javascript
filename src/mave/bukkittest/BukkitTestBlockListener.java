...
public class BukkitTestBlockListener extends BlockListener
{
	private EventRegistration m_eventRegistration = null;
	
    public BukkitTestBlockListener(EventRegistration eventRegistration)
    {
    ...
    public void onBlockPhysics(BlockPhysicsEvent event)
    {
		if (m_eventRegistration.m_eventType == Event.Type.BLOCK_PHYSICS)
		{
	    	...
	    	m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, block, new Object[] { material } );
    ...
    public void onBlockCanBuild(BlockCanBuildEvent event)
    {
    	if (m_eventRegistration.m_eventType == Event.Type.BLOCK_CANBUILD)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
	    	m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, block, new Object[] { material, event.isBuildable() } );
	    	globalScope.delete("_event");
		}
    }
    ...
    public void onBlockBreak(BlockBreakEvent event)
    {
    	if (m_eventRegistration.m_eventType == Event.Type.BLOCK_BREAK)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
	    	m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, block, new Object[] { player } );
	    	globalScope.delete("_event");
		}
    }
    ...
    public void onBlockBurn(BlockBurnEvent event)
    {
    	if (m_eventRegistration.m_eventType == Event.Type.BLOCK_BURN)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, block, new Object[] { } );
			globalScope.delete("_event");
		}
    }
    ...
    public void onBlockDamage(BlockDamageEvent event)
    {
    	if (m_eventRegistration.m_eventType == Event.Type.BLOCK_DAMAGE)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, block, new Object[] { player, itemInHand, event.getInstaBreak() } );
			globalScope.delete("_event");
		}
    }
    ...
    public void onBlockDispense(BlockDispenseEvent event)
    {
    	if (m_eventRegistration.m_eventType == Event.Type.BLOCK_DISPENSE)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, block, new Object[] { item, velocity } );
			globalScope.delete("_event");
		}
    }
    ...
    public void onBlockFromTo(BlockFromToEvent event)
    {
    	if (m_eventRegistration.m_eventType == Event.Type.BLOCK_FROMTO)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, block, new Object[] { toBlock, face } );
			globalScope.delete("_event");
		}
    }
    ...
    public void onBlockIgnite(BlockIgniteEvent event)
    {
    	if (m_eventRegistration.m_eventType == Event.Type.BLOCK_IGNITE)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, block, new Object[] { player, cause } );
			globalScope.delete("_event");
		}
    }
    ...
    public void onBlockPlace(BlockPlaceEvent event)
    {
    	if (m_eventRegistration.m_eventType == Event.Type.BLOCK_PLACE)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, block, new Object[] { player, blockPlaced, blockAgainst, itemInHand } );
			globalScope.delete("_event");
		}
    }
    ...
    public void onSignChange(SignChangeEvent event)
    {
    	if (m_eventRegistration.m_eventType == Event.Type.SIGN_CHANGE)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, block, new Object[] { player, lines } );
			globalScope.delete("_event");
		}
    }
    ...
    {    	
    	if (m_eventRegistration.m_eventType == Event.Type.REDSTONE_CHANGE)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, block, new Object[] { event.getOldCurrent(), event.getNewCurrent() } );
			globalScope.delete("_event");
		}
    }
}