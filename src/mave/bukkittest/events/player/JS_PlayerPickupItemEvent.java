...
public class JS_PlayerPickupItemEvent extends ScriptableObject
{
	private static final long serialVersionUID = 4362265687504555530L;
	public PlayerPickupItemEvent event = null;

	public JS_PlayerPickupItemEvent()
	{
	}
	...
	public void initializeFunctionProperties()
	{
		defineFunctionProperties(new String[] { "toString" },
				JS_PlayerPickupItemEvent.class, DONTENUM);
	}
