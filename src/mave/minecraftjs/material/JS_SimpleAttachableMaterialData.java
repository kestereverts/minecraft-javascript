...
public class JS_SimpleAttachableMaterialData<D extends SimpleAttachableMaterialData> extends JS_MaterialData<D>
{
	private static final long serialVersionUID = -4403484561023154666L;

	public JS_SimpleAttachableMaterialData()
	{	
	}
	...
	public Scriptable jsGet_attachedFace()
	{
	...
	public void jsSet_facingDirection(Scriptable facing)
	{
