...
import mave.bukkittest.events.block.JS_BlockBreakEvent;
import mave.bukkittest.events.block.JS_BlockBurnEvent;
import mave.bukkittest.events.block.JS_BlockCanBuildEvent;
import mave.bukkittest.events.block.JS_BlockDamageEvent;
import mave.bukkittest.events.block.JS_BlockDispenseEvent;
import mave.bukkittest.events.block.JS_BlockFromToEvent;
import mave.bukkittest.events.block.JS_BlockIgniteEvent;
import mave.bukkittest.events.block.JS_BlockPhysicsEvent;
import mave.bukkittest.events.block.JS_BlockPlaceEvent;
import mave.bukkittest.events.block.JS_BlockRedstoneEvent;
import mave.bukkittest.events.block.JS_LeavesDecayEvent;
import mave.bukkittest.events.block.JS_SignChangeEvent;
import mave.bukkittest.events.block.JS_SnowFormEvent;
import mave.bukkittest.events.entity.JS_CreatureSpawnEvent;
import mave.bukkittest.events.entity.JS_CreeperPowerEvent;
import mave.bukkittest.events.entity.JS_EntityCombustEvent;
import mave.bukkittest.events.entity.JS_EntityDamageEvent;
import mave.bukkittest.events.entity.JS_EntityDeathEvent;
import mave.bukkittest.events.entity.JS_EntityExplodeEvent;
import mave.bukkittest.events.entity.JS_EntityInteractEvent;
import mave.bukkittest.events.entity.JS_EntityTargetEvent;
import mave.bukkittest.events.entity.JS_ExplosionPrimeEvent;
import mave.bukkittest.events.entity.JS_PaintingBreakEvent;
import mave.bukkittest.events.entity.JS_PaintingPlaceEvent;
import mave.bukkittest.events.entity.JS_PigZapEvent;
import mave.bukkittest.events.player.JS_PlayerAnimationEvent;
import mave.bukkittest.events.player.JS_PlayerBedEnterEvent;
import mave.bukkittest.events.player.JS_PlayerBedLeaveEvent;
import mave.bukkittest.events.player.JS_PlayerBucketEmptyEvent;
import mave.bukkittest.events.player.JS_PlayerChatEvent;
import mave.bukkittest.events.player.JS_PlayerCommandPreprocessEvent;
import mave.bukkittest.events.player.JS_PlayerDropItemEvent;
import mave.bukkittest.events.player.JS_PlayerEggThrowEvent;
import mave.bukkittest.events.player.JS_PlayerInteractEntityEvent;
import mave.bukkittest.events.player.JS_PlayerInventoryEvent;
import mave.bukkittest.events.player.JS_PlayerItemHeldEvent;
import mave.bukkittest.events.player.JS_PlayerJoinEvent;
import mave.bukkittest.events.player.JS_PlayerKickEvent;
import mave.bukkittest.events.player.JS_PlayerLoginEvent;
import mave.bukkittest.events.player.JS_PlayerMoveEvent;
import mave.bukkittest.events.player.JS_PlayerPickupItemEvent;
import mave.bukkittest.events.player.JS_PlayerPreLoginEvent;
import mave.bukkittest.events.player.JS_PlayerQuitEvent;
import mave.bukkittest.events.player.JS_PlayerRespawnEvent;
import mave.bukkittest.events.player.JS_PlayerTeleportEvent;
import mave.bukkittest.events.player.JS_PlayerToggleSneakEvent;
...
public class Script
{
	...
	void load(File file) throws FileNotFoundException, IOException
	{
		...
		BukkitTest.m_currentScript = this;
