...
public class BukkitTestEntityListener extends EntityListener
{
	private EventRegistration m_eventRegistration = null;
	
	public BukkitTestEntityListener(EventRegistration eventRegistration)
	{
	...
	public void onCreatureSpawn(CreatureSpawnEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.CREATURE_SPAWN)
		{
			...
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, entity, new Object[] { creatureType, location } );
	...
	public void onCreeperPower(CreeperPowerEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.CREEPER_POWER)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, entity, new Object[] { null, cause } );
			globalScope.delete("_event");
		}
	}
	...
	public void onEntityCombust(EntityCombustEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.ENTITY_COMBUST)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, entity, new Object[] { } );
			globalScope.delete("_event");
		}
	}
	...
	public void onEntityDamage(EntityDamageEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.ENTITY_DAMAGE)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, entity, new Object[] { event.getDamage(), cause } );
			globalScope.delete("_event");
		}
	}
	...
	public void onEntityDeath(EntityDeathEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.ENTITY_DEATH)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, entity, new Object[] { drops } );
			globalScope.delete("_event");
		}
	}
	...
	public void onEntityExplode(EntityExplodeEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.ENTITY_EXPLODE)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, entity, new Object[] { blockList, location, event.getYield() } );
			globalScope.delete("_event");
		}
	}
	...
	public void onEntityInteract(EntityInteractEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.ENTITY_INTERACT)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, entity, new Object[] { block } );
			globalScope.delete("_event");
		}
	}
	...
	public void onEntityTarget(EntityTargetEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.ENTITY_TARGET)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, entity, new Object[] { target, reason } );
			globalScope.delete("_event");
		}
	}
	...
	public void onExplosionPrime(ExplosionPrimeEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.EXPLOSION_PRIME)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, entity, new Object[] { event.getRadius(), event.getFire() } );
			globalScope.delete("_event");
		}
	}
	...
	public void onPaintingBreak(PaintingBreakEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.PAINTING_BREAK)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, scope, new Object[] { cause } );
			globalScope.delete("_event");
		}
	}
	...
	public void onPaintingPlace(PaintingPlaceEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.PAINTING_PLACE)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, scope, new Object[] { player, block, face } );
			globalScope.delete("_event");
		}
	}
	...
	public void onPigZap(PigZapEvent event)
	{
		if (m_eventRegistration.m_eventType == Event.Type.PIG_ZAP)
		{
			...
			globalScope.put("_event", globalScope, ConvertUtility.toScriptable(event, cx, scope));
			m_eventRegistration.m_scriptFunction.call(cx, BukkitTest.m_currentScript.m_globalScope, scope, new Object[] { null, null } );
			globalScope.delete("_event");
		}
	}
}